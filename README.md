<h1 align="center">SHANKAR REGATI</h1>

<div align="center">

[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=2E9EF7&center=true&vCenter=true&width=500&lines=Aspiring+DevOps+and+Cloud+Engineer;Learning+DevOps+and+Cloud+Technologies;Building+Hands-on+Projects;90DaysOfDevOps+Challenge)](https://git.io/typing-svg)
...
I'm an Aspiring DevOps & Cloud Engineer from 🇮🇳 India, focused on building Strong fundamentals through hands-on projects and Consistent learning.

- 💻 Currently learning DevOps by building hands-on projects and completing the #90DaysOfDevOps challenge.
- 🎯 Focused on building Strong DevOps fundamentals in Automation, Containerization, Orchestration, CI/CD, Monitoring, and Cloud technologies.
- 💪🧘‍♂️ Outside tech, I practice Calisthenics and Meditation.
...
<p align="left">
  ...
  <img src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png" alt="github" width="60" height="60" style="background:white; padding:5px; border-radius:6px;"/>
</p>
...
<p align="left">
  ...
  <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/opentelemetry/opentelemetry-original.svg" alt="opentelemetry" width="60" height="60"/>
...
<table>
  <tr>
    <td width="50%">
      <h3>🐳 React-Node-Golang-Postgresql-Docker-Web-Application </h3>
      ...
      <br/>
      <br/>
<a href="https://github.com/SHANKAR-REGATI/React-Node-Golang-Postgresql-Docker-Web-Application">
  <img src="https://img.shields.io/badge/View_Repo-C8C8C8?style=for-the-badge&logo=github&logoColor=black"/>
</a>
      <br/><br/>
      <p>This project shows a Dockerized 3-tier application built with React, Node.js, Go, and PostgreSQL. Each service runs in an isolated Docker container and communicates through an internal Docker network and all containers are managed using Docker Compose.</p>
    </td>
    <td width="50%">
      <h3>⚙️ Ansible-nginx-static-site-deployment-using-Roles</h3>
      ...
      <br/><br/>
      <p>Automates installation and configuration of Nginx using Ansible roles, deploys a custom Nginx server block, and hosts a static website on an EC2 instance.</p>
    </td>
  </tr>
</table>
